...
namespace RoomBooking.API.Controllers
{
    ...
    [ApiController]
    public class BookingHistorysController : BasesController<BookingHistory>
    {
        IBookingHistoryService _service;
        // /// <summary>
        ...
        public BookingHistorysController(IBookingHistoryService service) : base(service)
        {
            _service = service;
        }
    }
